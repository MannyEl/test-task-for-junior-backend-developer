...
Откройте [Decisions.md](./Decisions.md) чтобы посмотреть мои комментарии по задачам. Там я описал что нужно добавить и почему было выбрано то или иное решение

Чтобы заполнить таблицу тестовыми данными
```bash
